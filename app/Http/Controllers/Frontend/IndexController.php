...
class IndexController extends Controller
{
    ...
    public function Index(){
        ...
        if ($skip_category_7) {
            ...
            // Handle the case when $skip_category_7 is null
            // For example, you can set $skip_product_7 to an empty array or handle it differently based on your application logic.
            $skip_product_7 = [];
         }
